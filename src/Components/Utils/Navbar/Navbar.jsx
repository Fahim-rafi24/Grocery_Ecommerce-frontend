  ...
  const navbarSearch = (
    <div className="relative w-full max-w-md">
      ...
      <svg
        ...
        className="w-5 h-5 text-gray-400 absolute top-1/2 left-4 transform -translate-y-1/2"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
  ...
  return (
    <>
      <div className="flex justify-between p-6 h-24 ">
        ...
        <div className="hidden md:block md:w-3/6 roboto">
          {navbarSearch}
        </div>
      ...
      {/* another search bar for small device */}
      <div className="md:hidden w-[90%] mx-auto h-12 mb-10 md:w-3/6">
        {navbarSearch}
      </div>
    </>
  )
